...
xtracted_titles = holdout["Name"].str.extract(' ([A-Za-z]+)\.',expand=False)
holdout["Title"] = xtracted_titles.map(titles)
...
Taccuracy = cross_val_score(lr, all_X ,all_y , cv=10)

accuracy =Taccuracy.mean()
